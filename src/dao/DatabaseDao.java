...
public class DatabaseDao {
	...
	public DatabaseDao()  throws Exception{
		//Class.forName("com.mysql.cj.jdbc.Driver").newInstance();//加载mysql驱动程序
		//connect=DriverManager.getConnection("jdbc:mysql://localhost:3306/news?useSSL=false&useUnicode=true&characterEncoding=utf8&serverTimezone=Hongkong", "root", "123456");
		//创建连接对象：参数包括数据库地址，用户名，密码
		/*DatabaseDao.drv ="com.mysql.cj.jdbc.Driver";
		DatabaseDao.url ="jdbc:mysql://localhost:3306/news?useSSL=false&serverTimezone=Hongkong";
