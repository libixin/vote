...
<html>
 <head>
  ...
  <body>
  <form action="/vote/servlet/userservlet?type1=changePrivate2" method="post" target="frame">
	<table width="400" border="0" align="center" cellspacing="0" cellpadding="0">
		<tbody>
			...
			<tr><td>头像：</td>	
				...
				<input id="myFile" name="myFile" type="file" onchange="preview()">
				...
				<tr><td height="60">简介：</td>
					<td><textarea name="intro">${requestScope.userinformation.intro}</textarea></td>
				</tr> 
