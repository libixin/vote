...
<script type="text/javascript">
	function valName(){
		...
		if(str1==null || str1==""){
			...
			document.getElementById("namespan").innerHTML="*至少需要4个字符，以字母开头，以字母或数字结尾，可以有-和_";
			return false;
		}
	}
	...
	function valPassword(){
		...
		if(document.getElementById("password").value==null || document.getElementById("password").value==""){
			...
			document.getElementById("passwordspan").innerHTML="*只能输入3-20个字母、数字、下划线";
			return false;
		}else{
...
<form action="/vote/servlet/userservlet?type1=register" method="post" onsubmit="return submit1()">
